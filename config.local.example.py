#!/usr/bin/env python3
"""
Local Configuration for FakeICAP Server
Copy this file to config.py for local development settings
"""

# Server Configuration
SERVER_HOST = '10.10.0.5'  # Replace with your actual server IP address
